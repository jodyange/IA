...
public class BlocksWorldRegularConfig extends BlocksWorldConstraints{
...
/**
     ...
     */
    public BlocksWorldRegularConfig(int nbBlocks, int nbPiles) {
    ...
    private void addRegularConstraints() {
        ...
        for (int bottom = 0; bottom < nbBlocks; bottom++) {
            for (int middle = 0; middle < nbBlocks; middle++) {
                ...
                if (middle == bottom) {
                    // un bloc ne peut pas être à la fois en bas et au milieu
                    continue;
                }
                ...
                for (int top = 0; top < nbBlocks; top++) {
                    ...
                    if (top == middle || top == bottom) {
                        // le bloc du haut doit être différent des deux autres
                        continue;
                    }
                    ...
                    if (middle - bottom != top - middle) {
                        ...
                        constraints.add(
                                new Implication(onMiddle, onMiddleValues, onTop, onTopAllowedValues)
                        );
                    }
                }
            }
    ...
    public static void main(String[] args) {
        BlocksWorldVariables myWorld = new BlocksWorldRegularConfig(5, 3);
